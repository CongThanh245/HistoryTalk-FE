...
function SkeletonCard() {
  return (
    <div
      className="w-full h-[320px] rounded-2xl border animate-pulse flex flex-col overflow-hidden"
      style={{
        background: "var(--card-light-bg)",
        borderColor: "var(--card-light-border)",
      }}
    >
      <div className="h-[180px] w-full" style={{ background: "var(--card-light-border)", opacity: 0.5 }} />
    ...
    <section className="mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {isLoading
          ...
          : events.map((event) => (
            ...
            >
              <div
                className="h-[320px] rounded-2xl border flex flex-col overflow-hidden relative"
                style={{
                  background: "var(--card-light-bg)",
                  borderColor: "var(--card-light-border)",
              ...
              >
                ...
                <div className="h-[180px] relative w-full border-b" style={{ borderColor: "var(--card-light-border)", background: "var(--bg-deep)" }}>
                ...
                <div className="p-4 flex-1 flex flex-col relative z-10 -mt-2 bg-[var(--card-light-bg)]">
                  ...
                  <h3 className="text-base font-bold line-clamp-1 mb-1.5 group-hover:text-[var(--accent-gold)] transition-colors" style={{ color: "var(--content-heading)" }}>
                    {event.title}
                  </h3>
      ...
      {!isLoading && events.length > 0 && (
        <div className="flex justify-center mt-6">
          <Link
            href="/events"
            className="flex items-center gap-1.5 px-6 py-2.5 rounded-xl border text-sm font-semibold transition-all duration-200"
            style={{
