...
// ── Types + mock ──────────────────────────────────────────
import type { ChatHistoryItem, ChatHistoryGroup } from "@/services/chat-history.service";
import { MOCK_HISTORY } from "@/services/chat-history.service";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(201,162,77,0.10) 0%, rgba(163,81,57,0.06) 100%)",
          border: "1px solid rgba(201,162,77,0.15)",
        }}
      >
        <History className="w-7 h-7" style={{ color: "var(--gold-on-light)", opacity: 0.5 }} />
      </div>
      <div className="text-center">
        <p className="text-base font-semibold" style={{ color: "var(--content-heading)" }}>
...
export default function ChatHistoryPage() {
  ...
  const allGroups: ChatHistoryGroup[] = MOCK_HISTORY;
  ...
  const eraCounts = (() => {
    ...
    allGroups.forEach((g) => {
      ...
      (Object.entries(ERA_CONFIG) as [EventEra, typeof ERA_CONFIG[EventEra]][]).forEach(([key, cfg]) => {
        if (key === "all") return;
      ...
      <div className="px-6 py-8 ">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            >
              <History className="w-5 h-5" style={{ color: "var(--gold-on-light)" }} />
            </div>
            <div>
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          <EraFilter active={era} onChange={(e) => { setEra(e); }} counts={eraCounts} />
